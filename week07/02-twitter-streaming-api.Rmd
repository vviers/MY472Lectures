...
```{r, eval=FALSE}
library(ROAuth)
my_oauth <- list(consumer_key = "u5dpTTLY4Zsba2i0hPIaUrbCR",
   consumer_secret = "EqmzsxnC2B4mc0cEtdr7tiybVszYgAnw4zN58vUNCGb2B2d4U0",
   access_token="720242111921041409-MP87iSXSAD7y1Tm4Dghjt3pNLEBA1f6",
   access_token_secret = "gPQrkexanzcliDqVArz4YG8uAwHuIcWftGmgIjgZ5v8HW")
